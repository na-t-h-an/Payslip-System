...
public interface PayPeriodRepository extends JpaRepository<PayPeriod, Long> {
    ...
    Optional<PayPeriod> findFirstByCompanyIdOrderByIdDesc(Long companyId);
    Optional<PayPeriod> findByCompanyIdAndStartDateAndEndDate(Long companyId, LocalDate startDate, LocalDate endDate);
}
